...
export default function AddNote() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-100 via-pink-100 to-purple-100">
      <div className="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-lg transform hover:scale-105 transition duration-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full p-3 border-2 border-pink-300 rounded-xl focus:outline-none focus:ring-4 focus:ring-pink-300 focus:border-pink-500 placeholder-gray-400 resize-none"
            />
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex-1 py-3 bg-gray-300 text-gray-700 font-bold rounded-xl shadow-lg hover:shadow-xl hover:bg-gray-400 transition"
            >
              Cancel
            </button>
          </div>
